...
struct RunwayPalette: Equatable {
    ...
    static let light = RunwayPalette(
        ...
        onAction: .white,
        plus: Color(red: 36 / 255, green: 108 / 255, blue: 99 / 255),
        agent: Color(red: 36 / 255, green: 108 / 255, blue: 99 / 255),
    ...
    static let dark = RunwayPalette(
        ...
        plus: Color(red: 0.46, green: 0.76, blue: 0.70),
        agent: Color(red: 0.46, green: 0.76, blue: 0.70),

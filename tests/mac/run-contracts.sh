...
for test in BrandMaterialContractTests AnswerDocumentContractTests AppRuntimeContractTests InteractionFocusTests AgentServiceMonitorContractTests LearningInputContractTests ConversationReplayTests LearningMemoryContractTests SessionDeletionContractTests SessionListSelectionTests KnowledgeDeckNavigationTests; do

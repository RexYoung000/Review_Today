...
for test in AnswerDocumentContractTests AppRuntimeContractTests InteractionFocusTests AgentServiceMonitorContractTests LearningInputContractTests ConversationReplayTests LearningMemoryContractTests SessionDeletionContractTests; do

...
subprocess.run(['xcrun','swiftc','-parse-as-library','-swift-version','5','-default-isolation','MainActor','tools/mascot-motion/native/MrBPresentation.swift','tools/mascot-motion/native/MrBPreviewModel.swift','tests/mac/MrBPresentationTests.swift','-o',str(binary)],check=True)

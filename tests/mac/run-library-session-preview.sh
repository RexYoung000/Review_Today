...
commands = [
    ['xcrun', 'swiftc', '-parse-as-library', '-D', 'DEBUG', '-swift-version', '5', '-default-isolation', 'MainActor', '-target', 'arm64-apple-macos26.5', *sources, 'tests/mac/LibrarySessionPreview.swift', '-o', str(binary)],

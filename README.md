...
2026-09-17 搜索职责修订：已改为 Harness 直接执行独立搜索和网页读取，移除 DeepSeek 托管搜索路径；模型配置不变。独立搜索服务选型与密钥待完成，目前不可报告联网恢复。见 [A008 最新证据](docs/evidence/2026-09-17-independent-web/README.md)。

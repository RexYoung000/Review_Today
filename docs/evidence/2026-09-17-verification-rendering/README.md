...
> 本页保留第一阶段证据。后续已确认 DeepSeek 的 Anthropic 接口支持真实搜索，Rex 授权接入；当前交付与网络阻塞见 [A008 搜索适配续修](../2026-09-17-deepseek-search/README.md)。下方“服务方案待确认/当前 unavailable”仅代表当时 Responses 路径，不代表最新能力。

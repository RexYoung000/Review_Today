...
for(const name of ['settlement-scene.mjs','settlement-player.mjs','settlement-flow.mjs','settlement-sequences.mjs','reaction-scene.mjs','paragraph-rows.mjs']) imports['@review-motion/'+name]='data:text/javascript;base64,'+Buffer.from((await readFile(resolve(toolRoot,'src',name),'utf8')).replaceAll("'./paragraph-rows.mjs'","'@review-motion/paragraph-rows.mjs'").replaceAll("'./settlement-sequences.mjs'","'@review-motion/settlement-sequences.mjs'").replaceAll("'./settlement-scene.mjs'","'@review-motion/settlement-scene.mjs'").replaceAll("'./settlement-character.mjs'","'@review-motion/settlement-character.mjs'").replaceAll("'../../../brand/refresh-2026-09/motion-rig/mesh-renderer.mjs'","'@review-motion/mesh-renderer.mjs'")).toString('base64');

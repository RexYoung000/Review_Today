...
from .boundaries import analyze, file_hash, load_scenarios, plan, verify_selection
...
def summarize_harness(path):
    ...
    return dict(result=base, groups=groups, paired=paired, new_jev_requests=0,

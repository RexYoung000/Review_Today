...
- 本机真实 TTS 播放音量驱动闭口、小开口、中开口和大开口；更宽的温柔月牙笑只在句末短暂出现。眨眼、呆毛和身体重心采用独立低幅节奏，不让全身机械跟随音量。
- V12 第一张五档嘴型表被 Rex 发现存在统一平直上沿，连续排列时形成明显横向截断带，视觉上像贴纸或裁切错误。该嘴型表已作废；替换稿改为完整、微不规则的封闭椭圆轮廓，上下都有弧度，且所有不透明像素与素材边缘保持安全距离。
- 第二稿仍被 Rex 指出闭口线端、小开口扁平度和方牙横线存在截断感。V12.1 改用完整尖尾月牙闭口、近圆小 O 和无板牙句末月牙笑，预览为 `mascot-mouth-animation-preview-v12-1.png`；该方向已被 Rex 接受并替换进运行资源。最宽嘴型四周仍保留 10 px 透明安全边距。
